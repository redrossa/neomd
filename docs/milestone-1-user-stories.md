...
Status: Historical brainstorm; unresolved proposals remain draft. Published GitHub issues are the implementation contracts. Stories #1–13 and priority stories #40–43, #48 and #50 are closed; #43 merged as PR #47, #48 as PR #49 and #50 as PR #51 (`918cfa40f9fdb7323400021b3a06b11f1ff8cf69`). The [priority pivot](milestone-1-priority-pivot.md), [focus-outline pivot](milestone-1-focus-outline-pivot.md) and [Command-click pivot](milestone-1-command-click-pivot.md) record those approved changes and validation limits. #50 restores Command-click local Markdown links to an additional reader, including already-open destinations; ordinary clicks still replace the source. This supersedes only #43's Command-N-only additional-reader restriction. The user-approved [window-cascade pivot](milestone-1-window-cascade-pivot.md), [#52 — M1-P7](https://github.com/redrossa/neomd/issues/52), is next and is the only authorized story: position Command-click readers slightly down/right from the captured source top-left with usable-screen edge handling. Earlier claims that placement was done were incorrect; #50's constructor still centers windows at this base. **#14 is entirely deferred; #15–24 remain paused, including after #52.** Do not resume them without renewed user direction. The [milestone order](https://github.com/redrossa/neomd/milestone/1) is authoritative. #48 supersedes only earlier enclosing link-block focus-indicator requirements, preserving keyboard/accessibility behavior and ordinary controls. Current gates are Debug build and relevant non-interaction units only, with no reviewer; all #52 physical placement/interaction checks remain deferred/unrun, not passed, and combined milestone acceptance remains user-owned. Historical implementation/status paragraphs below remain their original planning/evidence records, not authorization to advance or claims of current validation.
