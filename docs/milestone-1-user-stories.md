...
Status: Historical brainstorm; unresolved proposals remain draft. Published GitHub issues are the implementation contracts. Stories #1–13 and priority stories #40–43 and #48 are closed; #43 merged as PR #47 and #48 as PR #49. The [priority pivot](milestone-1-priority-pivot.md) and [focus-outline pivot](milestone-1-focus-outline-pivot.md) record those approved changes and their validation limits. The user-approved [Command-click pivot](milestone-1-command-click-pivot.md), [#50 — M1-P6](https://github.com/redrossa/neomd/issues/50), is next and is the only authorized story. It restores Command-click on local Markdown links to an additional reader, including already-open destinations; ordinary clicks still replace the source reader. This supersedes only #43's Command-N-only additional-reader restriction. **#14 is entirely deferred; #15–24 remain paused, including after #50.** Do not resume them without renewed user direction. The [milestone order](https://github.com/redrossa/neomd/milestone/1) is authoritative. #48 supersedes only earlier enclosing link-block focus-indicator requirements, preserving keyboard/accessibility behavior and ordinary controls. Historical implementation/status paragraphs below remain their original planning/evidence records, not authorization to advance or claims of current validation.
