...
[AMBER](#p9-top-4) is the top sentinel. This is a read-only, local, mixed-height scrolling corpus. [End sentinel](#p9-end) is an explicit navigation control, not a scrolling trigger. The document contains no images or background network activity.
...
AMBER P9-FIFTH-ONLY is the top sentinel. This is a read-only, local, mixed-height scrolling corpus. [End sentinel](#p9-end) is an explicit navigation control, not a scrolling trigger. The document contains no images or background network activity.
