# Complete pinned Unicode-backed shortcode inventory

Each row is a case-sensitive alias followed by its Unicode oracle. The code column remains literal; the prose shortcode becomes the same Unicode scalars as the final column. All 1,913 aliases are present.
